...
<a name="1.3.0"></a>
# [1.3.0](https://github.com/StyleLounge/http-queue/compare/v1.2.0...v1.3.0) (2016-10-25)


### Features

* Uses dbg to log payload if needed ([adfdacd](https://github.com/StyleLounge/http-queue/commit/adfdacd))
